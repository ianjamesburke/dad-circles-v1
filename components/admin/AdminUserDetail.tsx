  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className={`px-3 py-1.5 rounded-lg text-sm font-medium ${profile.onboarded
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-slate-500 text-xs uppercase tracking-wider mb-1">Abandonment Email Sent</p>
                <div className="flex flex-col">
                  <p className={profile.abandonment_sent ? 'text-green-400' : 'text-slate-500'}>
                    {profile.abandonment_sent ? 'Yes' : 'No'}
                  </p>
                  {profile.abandonment_sent && profile.abandonment_sent_at && (
                    <p className="text-slate-400 text-xs mt-0.5">
                      {new Date(profile.abandonment_sent_at?.toMillis?.() || profile.abandonment_sent_at || 0).toLocaleString()}
                    </p>
                  )}
                </div>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
            ...
            <div className="space-y-4">
              ...
              {abandonmentEmailStatus && (
                <div className={`text-sm text-center p-2 rounded-lg ${abandonmentEmailStatus.type === 'success'
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                ...
                messages.map(msg => (
                  ...
                  >
                    <div className={`max-w-[80%] rounded-xl px-4 py-3 ${msg.role === Role.USER
